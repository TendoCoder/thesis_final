...
After recalling the necessary local ramification theory, we first treat
tamely ramified torsors and $\mathbb{Z}/p\mathbb{Z}$-torsors by reducing the
calculation to explicit Kummer and Artin--Schreier equations on $\mathbb{G}_m$.
We then treat cyclic $p$-groups using Artin--Schreier--Witt theory. Finally,
the general finite abelian case follows by decomposing $G$ into its primary
cyclic factors and applying the compatibility of ramification with quotients
