...
products d times and one time as $\KG$ qoutient}
...
%     $X'^{(d)}_G = \KG \backslash X'^d/S_d$ be the symmetric power of $X'$ as a $G$-torsor.
%     By \Cref{prop:prop:symmetric_power_torsor} and the fact that $\KG, S_d$ actions commute, 
