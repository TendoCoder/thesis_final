\section{Two Reductions Before the Cyclic Calculations}
\label{section:reductions_before_cyclic_theories}

Before introducing explicit equations, we isolate the two reductions that
explain why the calculations below concern cyclic torsors on
$\bG_m \subset \bP^1_k$.
...
\subsection{Formal--Local Reduction to \texorpdfstring{$\bP^1$}{P1}}
