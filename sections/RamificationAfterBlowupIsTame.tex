...
The local cyclic torsors required by the preceding reduction have already
been put into explicit form by
\Cref{lemma:realization_over_Gm}. We now use those equations in the blowup
calculation.
