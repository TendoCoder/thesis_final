\section{A Wrong Path}\label{section:a_wrong_path}
In this section we want to explain why \Cref{theorem:ramification_after_blowup_is_tame_for_p_power} is
...
\subsection{The master diagram}\label{sec:master}
...
\subsection{Unramifiedness of $\cP^{[d]_G}$ at $\eta_C$}
So, going back to the begining of this section, a natural way to prove \Cref{theorem:ramification_after_blowup_is_tame_for_p_power}
...
\subsection{Difficulties in Proving the Theorem}
...
\subsubsection*{The inertia injection, and why \textnormal{(H2)} is not enough}
...
\subsubsection*{Absorption made explicit: two local fields}
