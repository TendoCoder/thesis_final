...
\]
The vertical map $q$ is the canonical comparison morphism from the symmetric
power of $\cP/H$ as a scheme to its symmetric power as a $G/H$-torsor.
\end{prop}
...
three labelled torsors and the comparison map $q$. The factorization
\[
